...
public class TreeArrowRenderer extends ArrowRenderer<TreeArrowEntity>
{

    public static final ResourceLocation TEXTURE = new ResourceLocation(PterosCustomArrowsMod.MOD_ID,
            "textures/entity/tree_arrow.png");

    public TreeArrowRenderer(EntityRendererProvider.Context manager) {
        super(manager);
    }

    @Override
    public ResourceLocation getTextureLocation(TreeArrowEntity arrow) {
        return TEXTURE;
    }
}
