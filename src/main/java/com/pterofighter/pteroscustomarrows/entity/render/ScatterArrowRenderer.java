...
public class ScatterArrowRenderer extends ArrowRenderer<ScatterArrowEntity>
{
    ...
    public ScatterArrowRenderer(EntityRendererProvider.Context manager) {
        super(manager);
    }

    @Override
    public ResourceLocation getTextureLocation(ScatterArrowEntity arrow) {
        return TEXTURE;
    }
}
