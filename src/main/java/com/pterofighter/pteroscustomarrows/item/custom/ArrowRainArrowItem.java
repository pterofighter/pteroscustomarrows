...
public class ArrowRainArrowItem extends ArrowItem
{

    public ArrowRainArrowItem(Properties p_40512_) {
        super(p_40512_);
    }

    @Override
    public AbstractArrow createArrow(Level pLevel, ItemStack pStack, LivingEntity pShooter) {
        return new ArrowRainArrowEntity(ModEntityTypes.ARROW_RAIN_ARROW.get(), pShooter, pLevel);
    }
